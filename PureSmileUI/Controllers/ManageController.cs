...
namespace PureSmileUI.Controllers
{
    ...
    public class ManageController : BaseController
    {
        ...
        //
        // GET: /Manage/Index
        public async Task<ActionResult> Index(ManageMessageId? message, bool? isModal)
        {
        ...
        public async Task<ActionResult> ManageLogins(ManageMessageId? message, string errorDetails)
        {
            ViewBag.StatusMessage =
                message == ManageMessageId.RemoveLoginSuccess ? "The external login was removed."
                : message == ManageMessageId.Error ? (string.IsNullOrEmpty(errorDetails) ? "An error has occurred." : errorDetails)
                : "";
            var user = await UserManager.FindByIdAsync(User.Identity.GetUserId<int>());
            if (user == null)
            {
        ...
        public async Task<ActionResult> LinkLoginCallback()
        {
            ...
            return result.Succeeded ? RedirectToAction("ManageLogins") : RedirectToAction("ManageLogins", new { Message = ManageMessageId.Error, ErrorDetails = string.Join("<br/>", result.Errors) });
        }
